namespace netz
{
    public class Help
    {
        ...
        internal static void PrintLogo()
        {
            ...
            Puts("| Copyright (C) 2004-2015 Vasian Cepa      |");
            Puts("| Copyright (C) 2022-*    Philippe TREILLE |");
            Puts("| [v" + Utils.NetzVersion+ "                                  |");
            Puts("|__________________________________________|");
            Puts(string.Empty);
        ...
        internal static void ShowHelp()
        {
            ...
            Puts("            [-csc] string");
            Puts("            [-unsafe]");
            Puts("            [-obfuscator] Level");
            Puts("            [-e] Extension");
            Puts("            [-manifest] ManifestFile");
            Puts(string.Empty);
            Puts(" Where:");
            Puts(string.Empty);
            ...
            Puts("\t-e extension Choice the new extension for dll");
            Puts("\t-unsafe Allow unsafe code in exe/dll");
            Puts("\t-obfuscator Level Obfuscate the code, with the level specified :");
            Puts("\t\t (0=No obfuscation, 1=Minimal, 2=Normal, 3=Aggressive, 4=Maximum)");
            Puts("\t-manifest ManifestFile Use a custom manifest file for the assembly generated");
            Puts(string.Empty);
            Puts(" Input files:");
