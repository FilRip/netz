...
namespace Confuser.Runtime
{
    internal static class Lzma
    {
        ...
        class LzmaDecoder
        {
            ...
            readonly bool _solid = false;

            uint m_DictionarySize;
            uint m_DictionarySizeCheck;
            readonly BitTreeDecoder m_PosAlignDecoder = new BitTreeDecoder(kNumAlignBits);
            ...
            class LenDecoder
            {
                ...
                readonly BitTreeDecoder m_HighCoder = new BitTreeDecoder(kNumHighLenBits);
                uint m_NumPosStates;
