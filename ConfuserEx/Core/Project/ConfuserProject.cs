...
namespace Confuser.Core.Project
{
    ...
    public class ConfuserProject : List<ProjectModule>
    {
        ...
        /// </summary>
        public static readonly XmlSchema Schema = XmlSchema.Read(typeof(ConfuserProject).Assembly.GetManifestResourceStream("ConfuserEx.Core.Project.ConfuserPrj.xsd"), null);
