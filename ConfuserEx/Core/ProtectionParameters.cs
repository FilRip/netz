...
namespace Confuser.Core
{
    ...
    public class ProtectionParameters
    {
        ...
        public T GetParameter<T>(ConfuserContext context, IDnlibDef target, string name, T defValue = default)
        {
            ...
            if (objParams == null)
                return defValue;
            if (!objParams.TryGetValue(comp, out Dictionary<string, string> parameters))
                return defValue;

            if (parameters.TryGetValue(name, out string ret))
            {
