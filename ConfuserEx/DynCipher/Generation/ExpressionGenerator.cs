...
namespace Confuser.DynCipher.Generation
{
    internal class ExpressionGenerator
    {
        ...
        {
            if (exp is BinOpExpression binExp)
            {
            ...
            else if (exp is UnaryOpExpression expression)
                SwapOperands(random, expression.Value);
