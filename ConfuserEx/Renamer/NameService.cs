...
namespace Confuser.Renamer
{
    ...
    internal class NameService : INameService
    {
        ...
        public void SetParam(IDnlibDef def, string name, string value)
        {
            ...
            if (!param.TryGetValue(analyze.Parent, out Dictionary<string, string> nameParam))
        ...
        public void Analyze(IDnlibDef def)
        {
            ...
            {
                GetVTables().GetVTable(type);
                SetOriginalNamespace(def, type.Namespace);
            }
        ...
        {
            string newName = null;
            name = ParseGenericName(name, out int? count);
