        ...
        class AntiDebugPhase : ProtectionPhase
        {
            ...
            protected internal override void Execute(ConfuserContext context, ProtectionParameters parameters)
            {
                ...
                foreach (ModuleDef module in parameters.Targets.OfType<ModuleDef>())
                {
                    ...
                    {
                        case AntiMode.Safe:
                            rtType = rt.GetRuntimeType(typeof(Runtime.AntiDebugSafe).FullName);
                            break;
                        case AntiMode.Win32:
                            rtType = rt.GetRuntimeType(typeof(Runtime.AntiDebugWin32).FullName);
                            break;
                        case AntiMode.Antinet:
                            rtType = rt.GetRuntimeType(typeof(Runtime.AntiDebugAntinet).FullName);
