...
namespace Confuser.Protections
{
    internal class Compressor : Packer
    {
        ...
        protected internal override void Pack(ConfuserContext context, ProtectionParameters parameters)
        {
            ...
            {
                KeyInjector ki = new KeyInjector(ctx);
                ModuleWriterOptions options = new ModuleWriterOptions(stubModule) { StrongNameKey = snKey };
                options.WriterEvent += ki.OnWriterEvent;
        ...
        static string GetId(byte[] module)
        {
            ...
            md.TablesStream.TryReadAssemblyRow(1, out RawAssemblyRow assemblyRow);
        ...
        class KeyInjector
        {
            ...
            public void OnWriterEvent(object sender, ModuleWriterEventArgs e)
            {
                ...
                else if (e.Event == ModuleWriterEvent.MDBeginAddResources && !ctx.CompatMode)
                {
