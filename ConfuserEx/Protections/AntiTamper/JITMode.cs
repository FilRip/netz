    ...
    internal class JITMode : IModeHandler
    {
        ...
        void CreateSection(ModuleWriterBase writer)
        {
            ...
            foreach (MethodDef method in methods.WithProgress(context.Logger))
            {
                ...
                method.Body = NopBody;
                dnlib.DotNet.MD.RawMethodRow rawMethodRow = writer.Metadata.TablesHeap.MethodTable[token.Rid];
                writer.Metadata.TablesHeap.MethodTable[token.Rid] = new dnlib.DotNet.MD.RawMethodRow(rawMethodRow.RVA,
                                                                                                     (ushort)(rawMethodRow.ImplFlags | (ushort)MethodImplAttributes.NoInlining),
                                                                                                     rawMethodRow.Flags,
                                                                                                     rawMethodRow.Name,
                                                                                                     rawMethodRow.Signature,
                                                                                                     rawMethodRow.ParamList);
