...
namespace dnlib.PE
{
    ...
    public sealed class ImageNTHeaders : FileSection
    {
        ...
        IImageOptionalHeader CreateImageOptionalHeader(ref DataReader reader, bool verify)
        {
            ...
            {
                case 0x010B:
                    return new ImageOptionalHeader32(ref reader, imageFileHeader.SizeOfOptionalHeader, verify);
                case 0x020B:
                    return new ImageOptionalHeader64(ref reader, imageFileHeader.SizeOfOptionalHeader, verify);
                default:
