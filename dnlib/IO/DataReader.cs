...
namespace dnlib.IO
{
    ...
    public struct DataReader
    {
        ...
        static void ThrowInvalidArgument(string paramName) => throw new DataReaderException($"Invalid argument value of {paramName}");
        ...
        /// </summary>
        /// <returns></returns>
        public Stream AsStream() => new DataReaderStream(this);
