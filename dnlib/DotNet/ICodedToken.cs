    ...
    public static partial class Extensions
    {
        ...
        public static TypeSig ToTypeSig(this ITypeDefOrRef type, bool checkValueType = true)
        {
            ...
            if (type is TypeRef tr)
            {
                if (checkValueType)
                    td = tr.Resolve();
                return CreateClassOrValueType(type, !(td is null) && td.IsValueType);
            }
        ...
        {
            return !(type is TypeSpec ts) ? null : ts.TypeSig.RemovePinnedAndModifiers() as TypeDefOrRefSig;
        }
        ...
        {
            return !(type is TypeSpec ts) ? null : ts.TypeSig.RemovePinnedAndModifiers() as ClassOrValueTypeSig;
        }
        ...
        {
            return !(type is TypeSpec ts) ? null : ts.TypeSig.RemovePinnedAndModifiers() as ValueTypeSig;
        }
        ...
        {
            return !(type is TypeSpec ts) ? null : ts.TypeSig.RemovePinnedAndModifiers() as ClassSig;
        }
        ...
        {
            return !(type is TypeSpec ts) ? null : ts.TypeSig.RemovePinnedAndModifiers() as GenericSig;
        }
        ...
        {
            return !(type is TypeSpec ts) ? null : ts.TypeSig.RemovePinnedAndModifiers() as GenericVar;
        }
        ...
        {
            return !(type is TypeSpec ts) ? null : ts.TypeSig.RemovePinnedAndModifiers() as GenericMVar;
        }
        ...
        {
            return !(type is TypeSpec ts) ? null : ts.TypeSig.RemovePinnedAndModifiers() as GenericInstSig;
        }
        ...
        {
            return !(type is TypeSpec ts) ? null : ts.TypeSig.RemovePinnedAndModifiers() as PtrSig;
        }
        ...
        {
            return !(type is TypeSpec ts) ? null : ts.TypeSig.RemovePinnedAndModifiers() as ByRefSig;
        }
        ...
        {
            return !(type is TypeSpec ts) ? null : ts.TypeSig.RemovePinnedAndModifiers() as ArraySig;
        }
        ...
        {
            return !(type is TypeSpec ts) ? null : ts.TypeSig.RemovePinnedAndModifiers() as SZArraySig;
        }
