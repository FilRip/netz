...
namespace dnlib.DotNet
{
    ...
    public abstract class TypeSig : IType
    {
        ...
        int IGenericParameterProvider.NumberOfGenericParameters
        {
            get
            {
                return !(this.RemovePinnedAndModifiers() is GenericInstSig type) ? 0 : type.GenericArguments.Count;
            }
        }
    ...
    public static partial class Extensions
    {
        ...
        /// <param name="self">this</param>
        /// <returns></returns>
        public static bool GetIsValueType(this TypeSig self) => !(self is null) && self.IsValueType;
        ...
        /// <param name="self">this</param>
        /// <returns></returns>
        public static bool GetIsPrimitive(this TypeSig self) => !(self is null) && self.IsPrimitive;
