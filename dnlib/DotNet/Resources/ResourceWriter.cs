...
namespace dnlib.DotNet.Resources
{
    ...
    public sealed class ResourceWriter
    {
        ...
        readonly ResourceElementSet resources;
        readonly ResourceDataFactory typeCreator;
        readonly Dictionary<UserResourceData, UserResourceType> dataToNewType = new Dictionary<UserResourceData, UserResourceType>();
        ...
        void InitializeUserTypes()
        {
            ...
            {
                if (!(resource.ResourceData is UserResourceData data))
                    continue;
