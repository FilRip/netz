...
namespace dnlib.DotNet
{
    ...
    public struct SigComparer
    {
        ...
        public bool Equals(IMemberRef a, IMemberRef b)
        {
            ...
            if (a is IType ta && b is IType tb)
                result = Equals(ta, tb);
            else if (a is IField fa && b is IField fb && fa.IsField && fb.IsField)
                result = Equals(fa, fb);
            else if (a is IMethod ma && b is IMethod mb)
                result = Equals(ma, mb);
            else if (a is PropertyDef pa && b is PropertyDef pb)
                result = Equals(pa, pb);
            else if (a is EventDef ea && b is EventDef eb)
                result = Equals(ea, eb);
            else
                result = false;
        ...
        public int GetHashCode(IMemberRef a)
        {
            ...
            else if (a is IField fa)
                result = GetHashCode(fa);
            else if (a is IMethod ma)
                result = GetHashCode(ma);
            else if (a is PropertyDef pa)
                result = GetHashCode(pa);
            else if (a is EventDef ea)
        ...
        /// <returns><c>true</c> if same, <c>false</c> otherwise</returns>
        public bool Equals(ITypeDefOrRef a, ITypeDefOrRef b) => Equals(a, (IType)b);
        ...
        public int GetHashCode(IType a)
        {
            ...
            if (a is TypeDef td)
                hash = GetHashCode(td);
            else if (a is TypeRef tr)
                hash = GetHashCode(tr);
            else if (a is TypeSpec ts)
                hash = GetHashCode(ts);
            else if (a is TypeSig sig)
                hash = GetHashCode(sig);
            else if (a is ExportedType et)
                hash = GetHashCode(et);
            else
        ...
        public bool Equals(TypeDef a, TypeRef b)
        {
            ...
            if (!Equals_TypeNames(a.Name, b.Name) || !Equals_TypeNamespaces(a.Namespace, b.Namespace))
                result = false;
            else if (scope is TypeRef dtb)  // nested type
            ...
            else if (a.DeclaringType != null)
            {
                ...
                result = true;
            else if (scope is IModule bMod) // 'b' is defined in the same assembly as 'a'
                result = Equals(a, bMod, b);
            else if (scope is AssemblyRef bAsm)
            {
                var aMod = a.Module;
        ...
        public bool Equals(TypeDef a, ExportedType b)
        {
            ...
            if (!Equals_TypeNames(a.Name, b.TypeName) || !Equals_TypeNamespaces(a.Namespace, b.TypeNamespace))
                result = false;
            else if (scope is ExportedType dtb)
            {   // nested type
                result = Equals(a.DeclaringType, dtb);  // Compare enclosing types
            }
            else if (a.DeclaringType != null)
        ...
        bool EqualsResolutionScope(TypeRef a, TypeRef b)
        {
            ...
            else if (aa != null && rb is ModuleDef modDef)
        ...
        {
            return a is ModuleDef mod && mod.IsManifestModule && mod.Assembly.IsCorLib();
        }
        ...
        bool Equals(ModuleDef a, ModuleDef b)
        {
            ...
            bool result = Equals(a, (IModule)b) && Equals(a.Assembly, b.Assembly);
                ...
                switch (a.ElementType)
                {
                    ...
                    case ElementType.Class:
                        if (RawSignatureCompare)
                            ...
                            result = Equals((a as ClassOrValueTypeSig).TypeDefOrRef, (IType)(b as ClassOrValueTypeSig).TypeDefOrRef);
                        break;
                    ...
                    case ElementType.CModOpt:
                        if (RawSignatureCompare)
                            ...
                            result = Equals((a as ModifierSig).Modifier, (IType)(b as ModifierSig).Modifier) &&
                                    Equals(a.Next, b.Next);
                        break;
            ...
            else
            {
                switch (a.GetCallingConvention() & CallingConvention.Mask)
                {
                    ...
                    case CallingConvention.Unmanaged:
                        result = a is MethodBaseSig ma && b is MethodBaseSig mb && Equals(ma, mb);
                        break;

                    case CallingConvention.Field:
                        result = a is FieldSig fa && b is FieldSig fb && Equals(fa, fb);
                        break;

                    case CallingConvention.LocalSig:
                        result = a is LocalSig la && b is LocalSig lb && Equals(la, lb);
                        break;

                    case CallingConvention.GenericInst:
                        result = a is GenericInstMethodSig ga && b is GenericInstMethodSig gb && Equals(ga, gb);
                        break;
        ...
        public int GetHashCode(CallingConventionSig a)
        {
            ...
            switch (a.GetCallingConvention() & CallingConvention.Mask)
            {
                ...
                case CallingConvention.NativeVarArg:
                case CallingConvention.Unmanaged:
                    hash = !(a is MethodBaseSig ma) ? 0 : GetHashCode(ma);
                    break;

                case CallingConvention.Field:
                    hash = !(a is FieldSig fa) ? 0 : GetHashCode(fa);
                    break;

                case CallingConvention.LocalSig:
                    hash = !(a is LocalSig la) ? 0 : GetHashCode(la);
                    break;

                case CallingConvention.GenericInst:
                    hash = !(a is GenericInstMethodSig ga) ? 0 : GetHashCode(ga);
                    break;
        ...
        public bool Equals(IMethod a, IMethod b)
        {
            ...
            else if (a is MethodSpec msa && b is MethodSpec msb)
        ...
        public int GetHashCode(IMethod a)
        {
            ...
            if (a is MethodDef mda)
                hash = GetHashCode(mda);
            else if (a is MemberRef mra)
                hash = GetHashCode(mra);
            else if (a is MethodSpec msa)
        ...
        bool Equals(IMemberRefParent a, IMemberRefParent b)
        {
            ...
            if (a is ITypeDefOrRef ita && b is ITypeDefOrRef itb)
                result = Equals(ita, (IType)itb);
            ...
            else if (a is MethodDef ma && b is MethodDef mb)
                result = Equals(ma, mb);
            else if (modb != null && a is TypeDef td)
        ...
        public bool Equals(EventDef a, EventDef b)
        {
            ...
            bool result = Equals_EventNames(a.Name, b.Name) &&
                    Equals(a.EventType, (IType)b.EventType) &&
        ...
        public bool Equals(TypeRef a, Type b)
        {
            ...
            if (!b.IsTypeDef())
                ...
                result = false;
            else if (scope is TypeRef dta)  // nested type
                result = Equals(dta, b.DeclaringType);  // Compare enclosing types
            else if (b.IsNested)
                result = false; // b is nested, a isn't
            else if (DontCompareTypeScope)
                result = true;
            else if (scope is IModule aMod) // 'a' is defined in the same assembly as 'b'
                result = Equals(b, aMod, a);
            else if (scope is AssemblyRef aAsm)
        ...
        public bool Equals(ExportedType a, Type b)
        {
            ...
            if (!b.IsTypeDef())
                ...
                result = false;
            else if (scope is ExportedType dta) // nested type
                result = Equals(dta, b.DeclaringType);  // Compare enclosing types
            else if (b.IsNested)
                result = false; // b is nested, a isn't
            else if (DontCompareTypeScope)
                result = true;
            else if (scope is FileDef aFile)
        ...
        {
            if ((a is Module module) && (module == b))
                return true;
            if (a is null || b is null)
                return false;
            if (!MscorlibIsNotSpecial && IsCorLib(a) && IsCorLib(b))
        ...
        {
            if ((a is Assembly assembly) && (assembly == b))
                return true;
            if (a is null || b is null)
                return false;
            if (!MscorlibIsNotSpecial && IsCorLib(a) && IsCorLib(b))
        ...
        bool DeclaringTypeEquals(IMethod a, MethodBase b)
        {
            ...
            if (a is MethodDef md)
                result = DeclaringTypeEquals(md, b);
            else if (a is MemberRef mr)
                result = DeclaringTypeEquals(mr, b);
            else if (a is MethodSpec ms)
        ...
        bool Equals(IMemberRefParent a, Type b, Module bModule)
        {
            ...
            else if (b is null && a is TypeDef td)
        ...
        bool ModifiersEquals(TypeSig a, IList<Type> reqMods2, IList<Type> optMods2, out TypeSig aAfterModifiers)
        {
            ...
            while (true)
            {
                if (!(aAfterModifiers is ModifierSig modifierSig))
                    break;
