...
namespace dnlib.DotNet.Writer
{
    ...
    public sealed class Win32ResourcesChunk : IReuseChunk
    {
        ...
        {
            GetFileOffsetAndRvaOf(dirEntry, out var fileOffset, out _);
            return fileOffset;
        }
        ...
        {
            GetFileOffsetAndRvaOf(dirEntry, out _, out RVA rva);
            return rva;
        }
        ...
        {
            GetFileOffsetAndRvaOf(dir, out var fileOffset, out _);
            return fileOffset;
        }
        ...
        {
            GetFileOffsetAndRvaOf(dir, out _, out RVA rva);
            return rva;
        }
        ...
        {
            GetFileOffsetAndRvaOf(dataHeader, out var fileOffset, out _);
            return fileOffset;
        }
        ...
        {
            GetFileOffsetAndRvaOf(dataHeader, out _, out RVA rva);
            return rva;
        }
        ...
        {
            GetFileOffsetAndRvaOf(name, out var fileOffset, out _);
            return fileOffset;
        }
        ...
        {
            GetFileOffsetAndRvaOf(name, out _, out RVA rva);
            return rva;
        }
        ...
        {
            if (e is ResourceData data)
                return dataHeaderDict[data];
