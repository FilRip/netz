...
namespace dnlib.DotNet.Writer
{
    ...
    public abstract class MethodBodyWriterBase
    {
        ...
        {
            if (instr.Operand is int entier)
        ...
        {
            if (instr.Operand is long entierLong)
        ...
        {
            if (instr.Operand is double virguleFlottante)
        ...
        {
            if (!(instr.Operand is IVariable variable))
            {
        ...
        {
            if (instr.Operand is sbyte octet)
                writer.WriteSByte(octet);
            else if (instr.Operand is byte octet2)
                writer.WriteByte(octet2);
            else
            {
        ...
        {
            if (instr.Operand is float single)
