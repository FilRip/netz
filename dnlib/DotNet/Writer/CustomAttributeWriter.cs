    ...
    public struct CustomAttributeWriter : IDisposable
    {
        ...
        void WriteValue(TypeSig argType, CAArgument value)
        {
            ...
            if (argType is SZArraySig arrayType)
            {
                ...
                if (argsArray is null && value.Value != null)
                    helper.Error("CAArgument.Value != null or an array");
        ...
        static bool VerifyValue(object o, ElementType etype)
        {
            ...
            switch (Type.GetTypeCode(o.GetType()))
            {
                case TypeCode.Boolean:
                    return etype == ElementType.Boolean;
                case TypeCode.Char:
                    return etype == ElementType.Char;
                case TypeCode.SByte:
                    return etype == ElementType.I1;
                case TypeCode.Byte:
                    return etype == ElementType.U1;
                case TypeCode.Int16:
                    return etype == ElementType.I2;
                case TypeCode.UInt16:
                    return etype == ElementType.U2;
                case TypeCode.Int32:
                    return etype == ElementType.I4;
                case TypeCode.UInt32:
                    return etype == ElementType.U4;
                case TypeCode.Int64:
                    return etype == ElementType.I8;
                case TypeCode.UInt64:
                    return etype == ElementType.U8;
                case TypeCode.Single:
                    return etype == ElementType.R4;
                case TypeCode.Double:
                    return etype == ElementType.R8;
                default:
                    return false;
            }
        }
