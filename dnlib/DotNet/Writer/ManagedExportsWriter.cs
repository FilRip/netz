...
#pragma warning disable IDE0060
            public NamesBlob(bool initialiseChamps)
            {
...
#pragma warning restore IDE0060
            ...
            public uint GetOtherNameOffset(string name)
            {
                ...
                return GetOffset(name, out var _);
            }
        ...
        void WriteSdataBlob(uint timestamp)
        {
            ...
            var namesBlob = new NamesBlob(true);
            int nameIndex = 0;
            bool error = false;
            foreach (var info in allMethodInfos)
            {
        ...
        void PatchSdataBytesBlob()
        {
            ...
            {
                Position = sdataBytesInfo.exportDirModuleNameStreamOffset
            };
