...
namespace dnlib.DotNet.Writer
{
    ...
    public sealed class MetadataOptions
    {
        ...
        public MetadataHeaderOptions MetadataHeaderOptions
        {
            get
            {
                if (metadataHeaderOptions == null)
                    metadataHeaderOptions = new MetadataHeaderOptions();
                return metadataHeaderOptions;
            }
        ...
        public MetadataHeaderOptions DebugMetadataHeaderOptions
        {
            get
            {
                if (debugMetadataHeaderOptions == null)
                    debugMetadataHeaderOptions = MetadataHeaderOptions.CreatePortablePdbV1_0();
        ...
        public TablesHeapOptions TablesHeapOptions
        {
            get
            {
                if (tablesHeapOptions == null)
                    tablesHeapOptions = new TablesHeapOptions();
                return tablesHeapOptions;
            }
        ...
        public TablesHeapOptions DebugTablesHeapOptions
        {
            ...
            {
                if (tablesHeapOptions == null)
                    tablesHeapOptions = TablesHeapOptions.CreatePortablePdbV1_0();
                return tablesHeapOptions;
            }
            set => tablesHeapOptions = value;
        }
    ...
    public abstract class Metadata : IReuseChunk, ISignatureWriterHelper, ITokenProvider, ICustomAttributeWriterHelper, IPortablePdbCustomDebugInfoWriterHelper, IWriterError2
    {
        ...
        internal sealed class SortedRows<T, TRow> where T : class where TRow : struct
        {
            ...
            readonly Dictionary<T, uint> toRid = new Dictionary<T, uint>();
            bool isSorted;
        ...
        {
            readonly Dictionary<T, uint> dict = new Dictionary<T, uint>();
