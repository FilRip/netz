...
namespace dnlib.DotNet.Writer
{
    ...
    public static class MDTableWriter
    {
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawFieldPtrRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            for (int i = 0; i < table.Rows; i++)
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawMethodPtrRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            for (int i = 0; i < table.Rows; i++)
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawParamPtrRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            for (int i = 0; i < table.Rows; i++)
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawInterfaceImplRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawConstantRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns2 = columns[2];
            var columns3 = columns[3];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawCustomAttributeRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawFieldMarshalRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawDeclSecurityRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns1 = columns[1];
            var columns2 = columns[2];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawClassLayoutRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns2 = columns[2];
            for (int i = 0; i < table.Rows; i++)
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawFieldLayoutRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns1 = columns[1];
            for (int i = 0; i < table.Rows; i++)
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawStandAloneSigRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            for (int i = 0; i < table.Rows; i++)
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawEventMapRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawEventPtrRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            for (int i = 0; i < table.Rows; i++)
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawPropertyMapRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawPropertyPtrRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            for (int i = 0; i < table.Rows; i++)
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawMethodSemanticsRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns1 = columns[1];
            var columns2 = columns[2];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawMethodImplRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawTypeSpecRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            for (int i = 0; i < table.Rows; i++)
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawFieldRVARow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns1 = columns[1];
            for (int i = 0; i < table.Rows; i++)
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawENCLogRow> table)
        {
            for (int i = 0; i < table.Rows; i++)
            {
                var row = table[(uint)i + 1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawENCMapRow> table)
        {
            for (int i = 0; i < table.Rows; i++)
            {
                var row = table[(uint)i + 1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawAssemblyProcessorRow> table)
        {
            for (int i = 0; i < table.Rows; i++)
            {
                var row = table[(uint)i + 1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawAssemblyOSRow> table)
        {
            for (int i = 0; i < table.Rows; i++)
            {
                var row = table[(uint)i + 1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawAssemblyRefProcessorRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns1 = columns[1];
            for (int i = 0; i < table.Rows; i++)
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawAssemblyRefOSRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns3 = columns[3];
            for (int i = 0; i < table.Rows; i++)
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawNestedClassRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawMethodSpecRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawGenericParamConstraintRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawDocumentRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawMethodDebugInformationRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawLocalScopeRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawImportScopeRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawStateMachineMethodRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
        ...
        /// <param name="writer">Writer</param>
        /// <param name="table">Table</param>
        public static void Write(this DataWriter writer, MDTable<RawCustomDebugInformationRow> table)
        {
            var columns = table.TableInfo.Columns;
            var columns0 = columns[0];
            var columns1 = columns[1];
