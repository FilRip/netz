...
namespace dnlib.DotNet
{
    ...
    struct TypeHelper
    {
        ...
        internal static bool ContainsGenericParameter(MethodSpec ms) => ms != null && ContainsGenericParameter(ms.GenericInstMethodSig);
        ...
        {
            if ((tdr is null) || (tdr is TypeRef) || (tdr is TypeDef))
                return false;
