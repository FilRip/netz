...
#pragma warning restore IDE0051
        ...
        static UTF8String GetName(ClrAssembly clrAsm)
        {
            switch (clrAsm)
            {
                case ClrAssembly.Mscorlib:
                    return ClrAsmName.clrAsmName_Mscorlib;
                case ClrAssembly.SystemNumericsVectors:
                    return ClrAsmName.clrAsmName_SystemNumericsVectors;
                case ClrAssembly.SystemObjectModel:
                    return ClrAsmName.clrAsmName_SystemObjectModel;
                case ClrAssembly.SystemRuntime:
                    return ClrAsmName.clrAsmName_SystemRuntime;
                case ClrAssembly.SystemRuntimeInteropServicesWindowsRuntime:
                    return ClrAsmName.clrAsmName_SystemRuntimeInteropServicesWindowsRuntime;
                case ClrAssembly.SystemRuntimeWindowsRuntime:
                    return ClrAsmName.clrAsmName_SystemRuntimeWindowsRuntime;
                case ClrAssembly.SystemRuntimeWindowsRuntimeUIXaml:
                    return ClrAsmName.clrAsmName_SystemRuntimeWindowsRuntimeUIXaml;
                default:
                    throw new InvalidOperationException();
            }
        }

        public static class ClrAsmName
        {
            public static readonly UTF8String clrAsmName_Mscorlib = new UTF8String("mscorlib");
            public static readonly UTF8String clrAsmName_SystemNumericsVectors = new UTF8String("System.Numerics.Vectors");
            public static readonly UTF8String clrAsmName_SystemObjectModel = new UTF8String("System.ObjectModel");
            public static readonly UTF8String clrAsmName_SystemRuntime = new UTF8String("System.Runtime");
            public static readonly UTF8String clrAsmName_SystemRuntimeInteropServicesWindowsRuntime = new UTF8String("System.Runtime.InteropServices.WindowsRuntime");
            public static readonly UTF8String clrAsmName_SystemRuntimeWindowsRuntime = new UTF8String("System.Runtime.WindowsRuntime");
            public static readonly UTF8String clrAsmName_SystemRuntimeWindowsRuntimeUIXaml = new UTF8String("System.Runtime.WindowsRuntime.UI.Xaml");

            public static readonly byte[] contractPublicKeyToken = new byte[] { 0xB0, 0x3F, 0x5F, 0x7F, 0x11, 0xD5, 0x0A, 0x3A };
            public static readonly byte[] neutralPublicKey = new byte[] { 0xb7, 0x7a, 0x5c, 0x56, 0x19, 0x34, 0xe0, 0x89 };
        }
        ...
        static byte[] GetPublicKeyToken(ClrAssembly clrAsm)
        {
            switch (clrAsm)
            {
                ...
                case ClrAssembly.SystemRuntimeWindowsRuntime:
                case ClrAssembly.SystemRuntimeWindowsRuntimeUIXaml:
                    return ClrAsmName.neutralPublicKey;
                case ClrAssembly.SystemNumericsVectors:
                case ClrAssembly.SystemObjectModel:
                case ClrAssembly.SystemRuntime:
                case ClrAssembly.SystemRuntimeInteropServicesWindowsRuntime:
                    return ClrAsmName.contractPublicKeyToken;
                default:
                    throw new InvalidOperationException();
            }
        }
        ...
        /// <returns></returns>
        public static TypeRef ToCLR(ModuleDef module, TypeDef td) => ToCLR(module, td, out _);
        ...
        /// <returns></returns>
        public static TypeRef ToCLR(ModuleDef module, TypeRef tr) => ToCLR(module, tr, out _);
        ...
        public static MemberRef ToCLR(ModuleDef module, MemberRef mr)
        {
            ...
            else if (cl is TypeSpec ts)
            {
                if (!(ts.TypeSig is GenericInstSig gis) || !(gis.GenericType is ClassSig))
                    return null;
